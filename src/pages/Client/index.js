...
const getDefaultPbInfo = () => ({
  ...
  profitMargin: 10,
  introduction: '안녕하세요. 투자 및 금융 분야에서 경험이 풍부한 PB로서 최고의 서비스를 제공하겠습니다.',
  experience: [
  ...
  return (
    <Container>
      <PhoneSize>
        ...
        <OrganismContact contact={{ imageUrl: pbInfo.imageUrl, tel: pbInfo.tel, email: pbInfo.email, current: pbInfo.current }} />
        <MolculeSpecialization specialization={pbInfo.specialization} />
        <AtomCumulativeStats cumulativeStats={{ customers: pbInfo.customers, totalAmount: pbInfo.totalAmount, profitMargin: pbInfo.profitMargin }} />
        <OrganismProfileSection profileData={{
